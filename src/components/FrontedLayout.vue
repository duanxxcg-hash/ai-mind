    ...
    <div class="frontend-layout">
        <div class="navbar-container">
            <div class="brand-section">
                <el-image style="width: 50px; height: 50px;" alt="品牌logo" :src="iconUrl"></el-image>
...
const isLoggedIn = ref(false) //此变量代表登录状态
...
onMounted(()=>{
    isLoggedIn.value = localStorage.getItem('token') !== null  //判断当前用户是否处于登录状态
})
